\usepackage{etoolbox}
\documentclass[10pt,oneside,tightlist]{memoir}
%\usepackage{etoolbox}
\usepackage{euler}
%\usepackage{xparse}
\usepackage[dvipsnames]{xcolor}
\usepackage{latexsym,amssymb,amsmath,eucal,times,stmaryrd, bbm}
\usepackage{tikz}
\usepackage{hyperref}
\usepackage{multicol}
\usepackage{listings}
\usepackage[paperwidth=9in, paperheight=6in,
            left=3mm,% right=3mm,
            top=1mm,bottom=1mm, right=3cm]{geometry}
...
\setcounter{exerciseCnt}{0}
\newcommand{\theExerciseCnt}{\arabic{exerciseCnt}}
\newcommand{\exer}{\stepcounter{exerciseCnt}\item[Ex~\theExerciseCnt.]}

%%%%% LaTeX syntax
%%%% control space above/below center environment
\newcommand*{\tightleft}{%
  \topsep=0.25\onelineskip\savetrivseps\setlength{\itemsep}{0pt}\trivlist \item\relax}
\def\endtightleft{\endtrivlist\restoretrivseps\vfill}

\newenvironment{lightleftbar}{%
...
\vspace{0.3\drop}
\textcolor{Dark}{\Large Sets and Functions}\par
\vspace{0.9\drop}
\textcolor{Dark}{\Large DISCRETE}\par
\vspace{0.4\drop}
\textcolor{Dark}{\Large MATHEMATICS}\par
\vspace{0.4\drop}
\textcolor{Medium}{\large M. Andrew Moshier}\par
\vspace{0.9\drop}
\begin{overview}
In the first installment of these notes, we concentrate on the structure of natural numbers and related objects (integers, rationals, lists and trees).
The main themes are
\begin{itemize}
\item The inductive structure of the natural numbers
\item The connections between counting, arithmetic, computation and proving the laws of algebra.
\item Using the idea of \emph{minimality} to characterize other types of mathematical data, including lists and binary trees, integers and rational numbers.
\end{itemize}
\end{overview}

\vspace{0.4\drop}

{\footnotesize August 2013}
}
\endgroup}
...
\newcommand{\ipadbreak}{\iftoggle{ipadformatting}{\pagebreak}{}}

\input{mydefs.tex}

\DeclareMathOperator{\sgn}{mathsf{sgn}}
\DeclareMathOperator{\Tri}{\mathsf{Tri}}
\DeclareMathOperator{\Pyr}{\mathsf{Pyr}}
\DeclareMathOperator{\HPyr}{\mathsf{HPyr}}
\DeclareMathOperator{\val}{\mathsf{val}}
\DeclareMathOperator{\num}{\mathsf{num}}
\newcommand{\ddiv}{\mathbin{/\hspace{-0.3em}/}}
\newcommand{\drem}{\mathbin{\%}}

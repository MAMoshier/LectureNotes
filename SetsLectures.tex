...
This leads us to suspect that set $A$ may be ``essentially the same'' as another set $B$, because they differ only a systematic matching of elements in $A$ with elements in $B$.  

...
We have already noted that a characteristic function $\fromto r{X\times Y}\Two$ corresponds to a subset of $X\times Y$. We can think of $r$ \emph{relating} elements of $X$ to elements of $Y$. This leads to a useful definition.
...
\begin{example}
	The relation of $\leq$ on real numbers can be regarded as subset $\mathord{\leq}\subseteq {\RR\times\RR}$ defined by $(x,y) \in \mathord\leq$ when $x$ is actually less than or equal to $y$ and $(x,y)\notin \mathord\leq$ otherwise. 
...
\begin{exercises}
	\begin{nextexercise}
		...
		\item Show that for any relation $R\subseteq X\times Y$, $\Delta_X;R = R = R;\Delta_X$.

...
A \noexpand\emph{set} is collection of things. To \emph{describe} a set, we typically will want to describe its ``structure''. This is, for now, an informal idea. To \emph{use} a set, we will want to assume at little about its as we can.

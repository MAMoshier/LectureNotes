...
The terms \emph{mono-} and \emph{epi-} refer to behavior that we explore in this Lecture.

A function $\sfromto fXY$ \emph{cancels on the right} say it is the case that for every $Y\doublerightarrow{h}{k}, if $h\circ f = k\circ f$ 

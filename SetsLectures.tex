...
For a function $\fromto fUV$, ${\mathord\ni}_V\circ (\id_{\powerset(U)}\times f)$ is a function from $\powerset(V)\times U$ to $\Two$. So there is a unique function
from $\powerset(V)$ to $\powerset(U)$ determined by $f$ according to the above princple.

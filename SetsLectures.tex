...
This principle shows that $\Two^A$ and $\powerset(A)$ are essentially the same.
So, in a sense, to understand the structure of $\powerset(A)$, it is enough to understand characteristic functions $A\to\Two$. In particular, we will concentrate on how to \emph{define} subsets of $A$. Definition 

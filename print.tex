...
\input{content/introduction.tex}
	...
	\mainmatter
	\part{Natural Numbers and Their Relatives}
	...
	Another early mathematical experience is learning to arrange things in some order. The informal concept of a \emph{list} captures this. We discuss lists formally, showing how they relate to natural numbers.
	...
	\input{content/OrderAndDivisibility.tex}
	\input{content/OtherNumbers.tex}
	\input{content/ModularArithmetic.tex}
	...
	\input{content/SetsFunctions.tex}
\end{document}
...
\input{SetsLectures.tex}

\part{Applications}

\input{Infinities.tex}

...
\begin{goals}
\begin{goal}{Lecture}
\item Describe the basic strcture of sets.
...
\emph{Functions}, introduced in Lecture \ref{lec:functions} are the mathematicians way of thinking about attributes of the things in a collection, like ``the color of'', ``the mass of'', ``the location of'', ``the father of'', ``the favorite book of the person to the left of'' and so on.
...
\end{itemize}
The answers to these questions lead to some basic principles. Namely, the ways that mathematicians actually use sets are generally governed by these principles.
We could be more formal and present these principles as \emph{axioms}, but the word ``axiom'' is used in mathematics to suggest that we intend these principles to be formal and to express everything in a minimal way.  We do not either the formality or the minimality here.
